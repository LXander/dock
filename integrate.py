...
source_path = '/n/scratch2/xl198/data/kaggle/test_set_npy'
...
def make_index():
    ...
    rec = []
    offset = [0]
    for dirpath,dirnames,filenames in chain(os.walk(os.path.join(source_path,'ligands'))):
    ...
    #np.save(os.path.join(dest_folder,'test_set_ligands.npy'),one_file)
    ...
    record.to_csv(os.path.join(dest_folder,'test_set_ligands.csv'),index=False)
